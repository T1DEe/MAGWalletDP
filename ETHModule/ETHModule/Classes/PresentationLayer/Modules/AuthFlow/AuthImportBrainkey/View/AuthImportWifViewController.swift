...
class AuthImportBrainkeyViewController: UIViewController {
    ...
    @IBOutlet weak var textViewTopConstaint: NSLayoutConstraint!
    ...
    private func config() {
        textViewTopDefault = textViewTopConstaint.constant
    ...
    private func keyboardWillShow(notification: Notification) {
        ...
        textViewTopConstaint.constant = -titleHeight - subtitleHeight
    ...
    private func keyboardWillHide(notification: Notification) {
        ...
        textViewTopConstaint.constant = topDefault
