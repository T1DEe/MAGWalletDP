//
//  ApplicationModuleApplicationModuleProtocols.swift
//  ETHModule
//
...
protocol ApplicationModulesOutputs: AuthRootModuleOutput, MainModuleOutput, SettingsModuleOutput, SendModuleOutput {
}
