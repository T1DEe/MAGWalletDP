//
//  ETHNotificationFacadeImp.swift
//  ETHModule
//
...
class ETHNotificationFacadeImp: ETHNotificationFacade {    
    private let adapters: [ETHNetworkType: ETHNetworkAdapter]
    var authService: ETHAuthService!
    var subscribeService: ETHSubscribeService!
    ...
    init(adapters: [ETHNetworkType: ETHNetworkAdapter]) {
    ...
    func subscribe(completion: @escaping (Result<ETHNotificationSuccess, ETHNotificationError>) -> Void) {
        ...
        operation.addExecutionBlock { [weak self, weak operation] in
            ...
            var states = [ETHNotificationState]()
    ...
    func unsubscribe(
        ...
        completion: @escaping (Result<ETHNotificationSuccess, ETHNotificationError>) -> Void
    ) {
    ...
    func getWallets(for network: ETHNetworkType) -> [ETHWallet] {
