//
//  PinVerificationSessionVerificationInteractor.swift
//  MAGWallet
//
...
class SessionVerificationInteractor {
    weak var output: SessionVerificationInteractorOutput!
    var authFacade: AuthFacade!
    var fingerprintAccessService: FingerprintAccessService!
}

// MARK: - SessionVerificationInteractorInput

extension SessionVerificationInteractor: SessionVerificationInteractorInput {
