...
class ChangeNetworkViewController: UIViewController {
    ...
    private var entity: ChangeNetworkScreenModel!
    ...
    private func configLocalization() {
        titleLabel.text = R.string.localization.settingsFlowChangeNetworkScreenTitle()
        headerTitleLabel.text = R.string.localization.settingsFlowChangeNetworkScreenTitle()
    }
...
extension ChangeNetworkViewController: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return entity.sections[section].networkModels.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let model = entity.sections[indexPath.section].networkModels[indexPath.row]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let model = section.networkModels[indexPath.row]
        if !model.isSelected {
            output.actionSelectNetwork(network: section.network, identifiableNetwork: model.identifiableNetwork)
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let model = entity.sections[section]
        cell.titleLabel.text = model.headerTitle
