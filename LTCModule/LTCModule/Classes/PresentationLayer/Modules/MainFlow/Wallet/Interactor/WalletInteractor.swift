...
class WalletInteractor {
    ...
    var ltcUpdateDelegateHandler: LTCUpdateEventDelegateHandler!
...
extension WalletInteractor: WalletInteractorInput {
    func bindToEvents() {
        ltcUpdateDelegateHandler.delegate = self
    ...
    func obtainInitialEntity() -> WalletEntity {
        ...
        let currency = Constants.LTCConstants.LTCSymbol
    ...
    func obtainInitialBalanceRate() -> WalletBalanceRateEntity {
        ...
        let satoshi = satoshiToLTC(satoshi: balance)
    ...
    func updateBalanceInfo() {
        ...
        updateService.updateWalletBalance(wallet: wallet) { [weak self] result in
            ...
            case .success(let balance):
                let amount = self.satoshiToLTC(satoshi: balance)
                let currency = Constants.LTCConstants.LTCSymbol
...
// MARK: - LTCUpdateEventDelegate

extension WalletInteractor: LTCUpdateEventDelegate {
