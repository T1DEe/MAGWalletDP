...
extension AccountsViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.ltcAccountsCellIdentifier,
                                                       for: indexPath) else {
...
// MARK: - LTCAccountsCellDelegate

extension AccountsViewController: LTCAccountsCellDelegate {
