//
//  LTCNotificationFacadeImp.swift
//  LTCModule
//
...
class LTCNotificationFacadeImp: LTCNotificationFacade {
    private let adapters: [LTCNetworkType: LTCNetworkAdapter]
    var authService: LTCAuthService!
    var subscribeService: LTCSubscribeService!
    ...
    init(adapters: [LTCNetworkType: LTCNetworkAdapter]) {
    ...
    func subscribe(completion: @escaping (Result<LTCNotificationSuccess, LTCNotificationError>) -> Void) {
        ...
        operation.addExecutionBlock { [weak self, weak operation] in
            ...
            var states = [LTCNotificationState]()
    ...
    func unsubscribe(
        ...
        completion: @escaping (Result<LTCNotificationSuccess, LTCNotificationError>) -> Void
    ) {
    ...
    func getWallets(for network: LTCNetworkType) -> [LTCWallet] {
