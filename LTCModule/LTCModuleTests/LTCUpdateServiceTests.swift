...
class LTCUpdateServiceTests: XCTestCase {
    ...
    override func setUp() {
        super.setUp()
        updateService = ApplicationAssembler.rootAssembler().assembler.resolver.resolve(LTCUpdateService.self)!
    }
    ...
    func testUpdateMainnetWalletBalance() {
        ...
        //arrange
        let wallet = LTCWallet(address: "LQTpS3VaYTjCr4s9Y1t5zbeY26zevf7Fb3", network: .testnet)
        let expect = expectation(description: "testUpdateWalletBalance")
    ...
    func testUpdateMainnetWalletsBalances() {
        ...
        //arrange
        let wallet = LTCWallet(address: "LQTpS3VaYTjCr4s9Y1t5zbeY26zevf7Fb3", network: .mainnet)
        let expect = expectation(description: "testUpdateWalletsBalances")
