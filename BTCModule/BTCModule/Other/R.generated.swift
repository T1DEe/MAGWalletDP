...
struct R: Rswift.Validatable {
  ...
  struct image {
    ...
    /// Image `btc_icon`.
    static let btc_icon = Rswift.ImageResource(bundle: R.hostingBundle, name: "btc_icon")
    /// Image `cancel`.
    ...
    /// `UIImage(named: "btc_icon", bundle: ..., traitCollection: ...)`
    static func btc_icon(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.btc_icon, compatibleWith: traitCollection)
    }
  ...
  struct reuseIdentifier {
    ...
    /// Reuse identifier `BTCAccountsCellIdentifier`.
    static let btcAccountsCellIdentifier: Rswift.ReuseIdentifier<BTCAccountsCell> = Rswift.ReuseIdentifier(identifier: "BTCAccountsCellIdentifier")
    ...
    /// Reuse identifier `HistoryItemCellReuseIdentifire`.
    static let historyItemCellReuseIdentifire: Rswift.ReuseIdentifier<HistoryItemCell> = Rswift.ReuseIdentifier(identifier: "HistoryItemCellReuseIdentifire")
  ...
  struct storyboard {
    ...
    /// Storyboard `SnackBars`.
    static let snackBars = _R.storyboard.snackBars()
    ...
    /// `UIStoryboard(name: "SnackBars", bundle: ...)`
    static func snackBars(_: Void = ()) -> UIKit.UIStoryboard {
      return UIKit.UIStoryboard(resource: R.storyboard.snackBars)
    }
  ...
  struct string {
    ...
    struct localization {
      ...
      /// Value: Block
      static let historyDetailsBlock = Rswift.StringResource(key: "history.details.block", tableName: "Localization", bundle: R.hostingBundle, locales: [], comment: nil)
      ...
      /// Value: Import your Bitcoin Brainkey
      ...
      /// Value: You don't have Bitcoin address yet
      ...
      /// Value: testnet
      static let settingsChangeNetworkTestnet = Rswift.StringResource(key: "settings.changeNetwork.testnet", tableName: "Localization", bundle: R.hostingBundle, locales: [], comment: nil)
      /// Value: to backup
      ...
      /// Value: Block
      static func historyDetailsBlock(_: Void = ()) -> String {
        return NSLocalizedString("history.details.block", tableName: "Localization", bundle: R.hostingBundle, comment: "")
      }
      ...
      /// Value: testnet
      static func settingsChangeNetworkTestnet(_: Void = ()) -> String {
        return NSLocalizedString("settings.changeNetwork.testnet", tableName: "Localization", bundle: R.hostingBundle, comment: "")
      }
...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct auth: Rswift.StoryboardResourceType, Rswift.Validatable {
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "authCopyCreate", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'authCopyCreate' is used in storyboard 'Auth', but couldn't be loaded.") }
        if UIKit.UIImage(named: "create_import", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'create_import' is used in storyboard 'Auth', but couldn't be loaded.") }
        if UIKit.UIImage(named: "import_eth", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'import_eth' is used in storyboard 'Auth', but couldn't be loaded.") }
        if #available(iOS 11.0, *) {
        }
        if _R.storyboard.auth().authCreateAndCopyViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'authCreateAndCopyViewController' could not be loaded from storyboard 'Auth' as 'AuthCreateAndCopyViewController'.") }
        if _R.storyboard.auth().authFlowSelectionViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'authFlowSelectionViewController' could not be loaded from storyboard 'Auth' as 'AuthFlowSelectionViewController'.") }
        if _R.storyboard.auth().authImportBrainkeyViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'authImportBrainkeyViewController' could not be loaded from storyboard 'Auth' as 'AuthImportBrainkeyViewController'.") }
        if _R.storyboard.auth().authRootViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'authRootViewController' could not be loaded from storyboard 'Auth' as 'AuthRootViewController'.") }
      }
    ...
    struct main: Rswift.StoryboardResourceType, Rswift.Validatable {
      ...
      let mainViewController = StoryboardViewControllerResource<BTCModule.MainViewController>(identifier: "MainViewController")
      let name = "Main"
      let receiveViewController = StoryboardViewControllerResource<BTCModule.ReceiveViewController>(identifier: "ReceiveViewController")
      let walletViewController = StoryboardViewControllerResource<BTCModule.WalletViewController>(identifier: "WalletViewController")
      ...
      static func validate() throws {
        ...
        if _R.storyboard.main().mainViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'mainViewController' could not be loaded from storyboard 'Main' as 'BTCModule.MainViewController'.") }
        if _R.storyboard.main().receiveViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'receiveViewController' could not be loaded from storyboard 'Main' as 'BTCModule.ReceiveViewController'.") }
        if _R.storyboard.main().walletViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'walletViewController' could not be loaded from storyboard 'Main' as 'BTCModule.WalletViewController'.") }
      }
    ...
    struct settings: Rswift.StoryboardResourceType, Rswift.Validatable {
      ...
      static func validate() throws {
        ...
        if UIKit.UIImage(named: "backup_wif", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'backup_wif' is used in storyboard 'Settings', but couldn't be loaded.") }
        ...
        if _R.storyboard.settings().accountsViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'accountsViewController' could not be loaded from storyboard 'Settings' as 'AccountsViewController'.") }
    ...
    struct snackBars: Rswift.StoryboardResourceType, Rswift.Validatable {
      ...
      let bundle = R.hostingBundle
      let buttonSnackBarViewController = StoryboardViewControllerResource<BTCModule.ButtonSnackBarViewController>(identifier: "ButtonSnackBarViewController")
      let name = "SnackBars"
      let oneButtonSnackBarViewController = StoryboardViewControllerResource<BTCModule.OneButtonSnackBarViewController>(identifier: "OneButtonSnackBarViewController")
      ...
      func buttonSnackBarViewController(_: Void = ()) -> BTCModule.ButtonSnackBarViewController? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: buttonSnackBarViewController)
      }
      
      func oneButtonSnackBarViewController(_: Void = ()) -> BTCModule.OneButtonSnackBarViewController? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: oneButtonSnackBarViewController)
      }
      
      static func validate() throws {
        if UIKit.UIImage(named: "errorIcon", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'errorIcon' is used in storyboard 'SnackBars', but couldn't be loaded.") }
        if UIKit.UIImage(named: "ic-ok", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'ic-ok' is used in storyboard 'SnackBars', but couldn't be loaded.") }
        if UIKit.UIImage(named: "ic_swipe", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'ic_swipe' is used in storyboard 'SnackBars', but couldn't be loaded.") }
        if #available(iOS 11.0, *) {
        }
        if _R.storyboard.snackBars().applySnackBarViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'applySnackBarViewController' could not be loaded from storyboard 'SnackBars' as 'ApplySnackBarViewController'.") }
        if _R.storyboard.snackBars().buttonSnackBarViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'buttonSnackBarViewController' could not be loaded from storyboard 'SnackBars' as 'BTCModule.ButtonSnackBarViewController'.") }
        if _R.storyboard.snackBars().oneButtonSnackBarViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'oneButtonSnackBarViewController' could not be loaded from storyboard 'SnackBars' as 'BTCModule.OneButtonSnackBarViewController'.") }
      }
