...
class HistoryViewController: UIViewController {
    ...
    var isLoading = false
    var responce: PagedResponse<BTCHistoryEntity>?
    ...
    private func configCell(tableView: UITableView, indexPath: IndexPath, model: BTCHistoryEntity) -> UITableViewCell? {
    ...
    private func configSendCell(tableView: UITableView, indexPath: IndexPath, model: BTCHistoryEntity) -> UITableViewCell? {
    ...
    private func configReceiveCell(tableView: UITableView, indexPath: IndexPath, model: BTCHistoryEntity) -> UITableViewCell? {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: R.reuseIdentifier.universalHistoryCellIdentifire,
                                                       for: indexPath) else {
                                                        return nil
        }
    ...
    private func updateHistory(response: PagedResponse<BTCHistoryEntity>) {
